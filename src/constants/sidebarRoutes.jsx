...
const sidebarConstant = [
  ...
  },
  {
    ...
    links: "/landbank",
    allowedGroups: ['ADMIN', 'LAND', 'PROJECT']
  },
  {
    name: 'SFA',
  ...
  },
  {
    name: 'Project',
    icons: <svg width="22" height="22" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M13 13V5M6.33333 15.6667V5M19.6667 18.3333V5M4.2 1H21.8C22.6487 1 23.4626 1.33714 24.0627 1.93726C24.6629 2.53737 25 3.35131 25 4.2V21.8C25 22.6487 24.6629 23.4626 24.0627 24.0627C23.4626 24.6629 22.6487 25 21.8 25H4.2C3.35131 25 2.53737 24.6629 1.93726 24.0627C1.33714 23.4626 1 22.6487 1 21.8V4.2C1 3.77977 1.08277 3.36365 1.24359 2.97541C1.4044 2.58717 1.64011 2.23441 1.93726 1.93726C2.53737 1.33714 3.35131 1 4.2 1Z" stroke="#C12463" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>,
    links: "/project",
    allowedGroups: ['ADMIN', 'PROJECT', 'HOD_TEAM'],
    subNavs: [
      {
  ...
  },
  {
    ...
    links: "/quality-main",
    allowedGroups: ['ADMIN', 'HOD_TEAM', 'O&M_TEAM']
  },
  {
    name: "Hoto",
    icons: <HiClipboardDocumentCheck/>,
    links: '/hoto-page',
    allowedGroups: ['ADMIN', 'HOD_TEAM']
  },
  {
    name: 'HSE',
  ...
  },
  {
    ...
    links: "/reports",
    allowedGroups: ['ADMIN', 'LAND', 'PROJECT', 'HOD_TEAM']
  },
  {
    name: 'General',
