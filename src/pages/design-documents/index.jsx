...
// Import the separated charts and reports utility
import { exportToExcelWithCharts } from "./ChartsAndReportsUtility";
...
function DesignDocumentsPage() {
  ...
  // Export to Excel function - now using imported utility
  const exportToExcel = () => {
