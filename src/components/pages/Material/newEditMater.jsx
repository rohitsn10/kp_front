...
import { useGetMaterialsQuery, useUpdateMaterialMutation } from "../../../api/material/materialApi";
...
export default function EditMaterialModal({
  ...
  useEffect(() => {
    if (materialToEdit) {
      setClientVendorChoice(materialToEdit.client_vendor_choices || "");
      setClientName(materialToEdit.client_name || "");
      setVendorName(materialToEdit.vendor_name || "");
      setMaterialNumber(materialToEdit.material_number || "");
      setMaterialName(materialToEdit.material_name || "");
      setUom(materialToEdit.uom || "");
      setPrice(materialToEdit.price || "");
      setPrNumber(materialToEdit.PR_number || "");
      setPoNumber(materialToEdit.PO_number || "");
      setQuantity(materialToEdit.quantity || "");
      setProjectName(materialToEdit.project_id || "");
      setPrDate(materialToEdit.pr_date || "");
      setPoDate(materialToEdit.po_date || "");
      setMaterialRequiredDate(materialToEdit.material_required_date || "");
    }
  }, [materialToEdit]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error("Error: " + (error.message || "Failed to update material"));
    }
  };
