...
export default function CraneHydraInspectionDialog({ open, setOpen,onSuccess }) {
  // RTK mutation hook
  ...
  const handleSubmit = async () => {
    ...
    if (inspectedBySignature) {
      ...
      const response = await createCraneHydraInspection(formData).unwrap();
    ...
    <Dialog open={open} onClose={handleClose} fullWidth maxWidth="lg">
      ...
      <DialogContent>
        ...
        <div className="my-4 border-t border-gray-300 pt-4">
          ...
          {renderInspectionField('swl_on_boom_lift', 'SWL mentioned on boom lift')}
          {renderInspectionField('any_leakage', 'Condition of hydraulic cylinder & any  leakage')}
          {renderInspectionField('speedometere', 'Speedometer & Gauges')}
        ...
        <div className="my-4 border-t border-gray-300 pt-4">
          ...
          <p className="mb-4 text-[#29346B] text-lg"> <span className="text-slate-950 font-semibold">Note:</span>  This checklist is applicable for all vehicles like- Trailer / Truck /JCB / Tractor / Transit   
            Mixer / Conveyance Vehicles /  Loader / Roller etc.
</p>
